...
func TestAccount_Withdraw(t *testing.T) {
	account := NewAccount("2859459814", "7386", 10024)
	balance, _ := account.Withdraw(4000)
...
func TestAccount_GetHistory_0_Transaction(t *testing.T) {
	account := NewAccount("2859459814", "7386", 10024)
	assert.Equal(t, account.GetHistory(), []TxRecord{})
}

func TestAccount_GetHistory_1_Transaction(t *testing.T) {
	account := NewAccount("2859459814", "7386", 10024)
	_, _ = account.Withdraw(4000)
...
func TestAccount_GetHistory_Another_1_Transaction(t *testing.T) {
	account := NewAccount("2859459814", "7386", 10024)
...
func TestAccount_GetHistory_2_Transactions(t *testing.T) {
	account := NewAccount("2859459814", "7386", 10024)
	_ = account.Deposit(4000)
	_, _ = account.Withdraw(3000)
	history := account.GetHistory()
